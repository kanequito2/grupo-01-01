...
public class FuncionarioJefe extends Funcionario{
	...
	public String getFuncionariosAMiCargo(int mes, int año){
		...
		for (int i=0; i<funcionariosAMiCargo.size(); i++){
			r = r + "Cedula: "+ funcionariosAMiCargo.get(i).getCedula() +", Nombre: "+ funcionariosAMiCargo.get(i).getNombre() + ", Sueldo: "+ funcionariosAMiCargo.get(i).generarSueldoNeto(mes, año)+"\n";
		}
		return r;
	}
