/*
 * Autor: Mirai
 * Opcion de Menu para Funcionario. Busca los apartamentos disponibles en Arriendo de acuerdo a ciertos criterios de busqueda.
 */
...
import suPropiedadRaiz.inmuebles.ApartamentoArriendo;

public class BuscarApartamentoArriendo  extends OpcionDeMenu{
	
	public BuscarApartamentoArriendo(){
		super.setNombre("Buscar un apartamento para arriendo");
	}
	...
	public void ejecutar(){
		...
		for(int i = 0; i < ListaInmuebles.getInmueblesRegistrados().size(); i++){
			if(ListaInmuebles.getInmueblesRegistrados().get(i) instanceof ApartamentoArriendo){
